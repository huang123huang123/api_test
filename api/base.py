...
from setting import BASE_URL,LOIN_INFO
import requests
...
class Base():
    ...
    def get_url(self,path,params=None):
        ...
        :return: ful_url: http://121.196.13.152:8080/admin/auth/login
        """
        if params:
    ...
    def post(self,url,data):
        ...
        try:
            ...
            logger.success("请求URL:{},请求参数:{},返回数据为:{}".format(url,data,result))
            return result
        except Exception as e:
...
if __name__ == '__main__':
    base = Base()
    # print(base.get_url('/admin/admin/updata'))
